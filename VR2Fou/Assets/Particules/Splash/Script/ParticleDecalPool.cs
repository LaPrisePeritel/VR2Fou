...
public class ParticleDecalPool : MonoBehaviour
{
    ...
    void SetParticleData(ParticleCollisionEvent particleCollisionEvent, Gradient colorGradient)
    {
        ...
        particleData[particleDecalDataIndex].position = new Vector3(particleCollisionEvent.intersection.x, particleCollisionEvent.intersection.y+0.1f, particleCollisionEvent.intersection.z);
